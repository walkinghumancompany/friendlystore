...
import 'package:friendlystore/cookingTimerClass.dart';
...
class CookingTimer extends StatefulWidget {
  const CookingTimer({Key? key}) : super(key: key);

  @override
  State<CookingTimer> createState() => _CookingTimerState();
}

class _CookingTimerState extends State<CookingTimer> with SingleTickerProviderStateMixin {
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            centerTitle: true,
            elevation: 0,
            title: Head(context, 'assets/Timer.png', isKaKao: false),
